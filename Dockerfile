...
RUN test -x /app/tools/apktool && test -f /app/tools/apktool.jar && \
    test -x /app/tools/jadx/bin/jadx && \
    java -jar /app/tools/apktool.jar --version >/dev/null && \
    /app/tools/jadx/bin/jadx --version >/dev/null
